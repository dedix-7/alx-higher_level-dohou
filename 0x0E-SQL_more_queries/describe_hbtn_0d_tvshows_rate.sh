...
echo ""
echo "Showing tables in the database hbtn_0d_tvshows" ; echo "" ; echo 'SHOW TABLES;' | mysql -hlocalhost -uroot -p hbtn_0d_tvshows_rate
echo ""
...
tv_show_ratings
echo ""
echo "tv_shows - Description" ; echo 'SELECT * FROM tv_show_ratings;' | mysql -hlocalhost -uroot -p hbtn_0d_tvshows_rate
