...
class State(Base):
    ...
    Attributes:
        id: A column of an auto-generated, unique integer, can’t be null and is a primary key
...
engine = create_engine("mysql+mysqldb://{}:{}@localhost:{}/{}".format(username, password, port, database), echo=True)
